...
const AIResponderDashboard = () => {
  ...
  const bookingRate = ((1 / 3) * 100).toFixed(1); // 1 booking out of 3 conversations
  ...
  return (
    <div className="stats-grid">
      ...
      <div className="card stat-card">
        <div className="stat-info">
          <p className="stat-label">Total Messages Sent</p>
      ...
      <div className="card stat-card">
        <div className="stat-info">
          <p className="stat-label">Total Messages Received</p>
      ...
      <div className="card stat-card">
        <div className="stat-info">
          <p className="stat-label">Booking Sent Rate</p>
          <p className="stat-value">{bookingRate}%</p>
        </div>
            ...
            <div className="card-content">
              ...
              >
                ...
                <p style={{ color: "#6b7280", marginBottom: "16px" }}>
                  Having trouble with billing? Contact our support team for
                  assistance.
                </p>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        Connect your Calendly account or enter a link manually
                      </p>
                    </div>
                    <span
                      style={{
                  ...
                  >
                    ...
                    >
                      <select
                        ...
                        defaultValue="manual"
                      >
                        <option value="manual">Calendar URL</option>
                        <option value="calendly" disabled>
                          Connect Calendly to select links
                        </option>
                      </select>
                      <button
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      >
                        Connect your LinkedIn account to enable automatic
                        outreach
                      </p>
                    </div>
                    <span
